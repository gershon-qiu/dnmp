...
# pgsql phar posix pspell readline recode reflection session shmop 
# simplexml snmp soap sockets spl standard sybase_ct sysvmsg sysvsem 
...
if [ "${PHP_EXTENSIONS}" != "" ]; then
    ...
    apk add --no-cache autoconf g++ libtool re2c make curl-dev libxml2-dev linux-headers
fi
